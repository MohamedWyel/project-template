    ...
    <div className="checkout-container">
      <div className="checkout-content">
        ...
        <div className="expiry-cvc">
            <select name="expiryMonth" value={formData.date.month} onChange={handleChange} required>
            ...
            <select name="expiryYear" value={formData.date.setFullYear} onChange={handleChange} required>
            ...
            if (/^\d{0,3}$/.test(value)) { setFormData({ ...formData, cvc: value });} // limit to 3 digits يا رجالة
                }
            }
            maxLength={3}
            required
