...
app.get("/login", async (req, res) => {
  try {
    ...
    if (user) {
      ...
      res.send("there is no user by this name");
    }
  } catch (e) {
...
app.listen(3000, () => console.log("App started on port 3001"));
